...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		Select eleTest = new Select(element1);
		eleTest.selectByVisibleText("New York");
		driver.findElement(By.name("submitButton")).click();
		String title = driver.getTitle();
		System.out.println(title);
		driver.findElement(By.linkText("Duplicate Lead")).click();
		WebElement duplicate = driver.findElement(By.id("createLeadForm_companyName"));
		duplicate.clear();
		duplicate.sendKeys("CTS");
		WebElement firstName = driver.findElement(By.id("createLeadForm_firstName"));
		firstName.clear();
		firstName.sendKeys("Kavitha");
		driver.findElement(By.name("submitButton")).click();
		String title1 = driver.getTitle();
		System.out.println("Duplicate lead  ="+title1);
	}
}
