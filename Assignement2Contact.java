...
public class Assignement2Contact {
	...
	public static void main(String[] args) {
		...
		//WebElement createContactForm_generalStateProvinceGeoIdElement = null;
		//WebElement stateElement = null;
		//WebElement generalStateProvinceGeoIdDropdownElement = null;
		Select generalStateProvinceGeoIdDropdown = new Select (createContactForm_generalStateProvinceGeoIddDropdown); 
		Select createContactForm_generalStateProvinceGeoIdropdown = null;
		createContactForm_generalStateProvinceGeoIdropdown.selectByVisibleText("Alaska");
