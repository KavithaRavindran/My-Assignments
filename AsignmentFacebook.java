...
public class AsignmentFacebook {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//div[@id = 'fullname_field']//input[@name = 'firstname']")).sendKeys("Prem");
	    //driver.findElement(By.name("lastname")).sendKeys("Kumar");
		driver.findElement(By.xpath("//div[@id = 'fullname_field']//input[@name = 'lastname']")).sendKeys("Kumar");
